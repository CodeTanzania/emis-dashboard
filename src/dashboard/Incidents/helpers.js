...
export const incidents = [
{
  ...
  "epicentre": {
    ...
    "properties": {
      ...
      "remarks": [
        "Recusandae odio ut dolore possimus in ut tempore."
      ],
      "description": "Autem libero et unde ut aut voluptates molestiae.",
      "startedAt": "2018-12-24T10:08:38.143Z",
...
,{
  ...
  "event": "Aliquid architecto non excepturi et tenetur maxime laudantium provident.",
  "causes": [
  ...
  "epicentre": {
    ...
    "properties": {
      ...
      "remarks": [
        "Sit temporibus aliquid in porro est aliquam."
      ],
  ...
  "epicentre": {
    ...
    "properties": {
      ...
      "remarks": [
        "Deserunt corporis labore libero aperiam."
      ],
...
,
{
  ...
  "causes": [
    "Fugit quia quisquam rerum quam eos ea sed enim."
  ],
...
,{
  ...
  "event": "Blanditiis dolor distinctio corporis odit aliquid nihil et dolorem doloribus.",
  "causes": [
    "Quis repellat adipisci aut placeat ab reprehenderit."
  ],
  "description": "Veritatis eum praesentium velit aut exercitationem sit possimus.",
  ...
  "epicentre": {
    ...
    "properties": {
      ...
      "remarks": [
        "Quibusdam suscipit voluptatum aut."
      ],
      "description": "Veritatis eum praesentium velit aut exercitationem sit possimus.",
      "startedAt": "2018-11-30T22:37:03.876Z",
