...
/* set plan schema */
export const SET_PLAN_SCHEMA = 'SET_PLAN_SCHEMA';
...
/* set plan activity schema */
export const SET_PLAN_ACTIVITY_SCHEMA = 'SET_PLAN_ACTIVITY_SCHEMA';
/*
 *------------------------------------------------------------------------------
...
/* set plan activity procedure schema */
export const SET_PLAN_ACTIVITY_PROCEDURE_SCHEMA =
