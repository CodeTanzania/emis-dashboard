    ...
    return (
      <Fragment >
        <Menu
          ...
          mode="inline"
        >
          <SubMenu key="sub1" title={<span><span>System Settings</span></span>}>
            <Menu.Item key="1">
            ...
            <SubMenu key="sub3" title="Warning">
              <Menu.Item key="3">
                <NavLink to='/settings/warning/message'>
                  Message Type
            </NavLink>
              </Menu.Item>
              <Menu.Item key="4">
                <NavLink to='/settings/warning/'>
                  Warning Type
             </NavLink></Menu.Item>
            </SubMenu>
            <Menu.Item key="5">
          ...
          <SubMenu key="sub3" title={<span><span>General Settings</span></span>}>
